...
export default function Home({ allPostsData }: InferGetServerSidePropsType<typeof getStaticProps>) {
  return (
    <Layout home>
      ...
      <div className='w-11/12 md:w-10/12 m-auto grid md:grid-cols-2 lg:grid-cols-3 gap-5'>
        {allPostsData.map(({ id, date, title, thumbnail }) => (
          <div
            key={id}
            className='flex flex-col border transition delay-75 border-darkGray p-5 hover:border-cyan rounded-lg'
          >
